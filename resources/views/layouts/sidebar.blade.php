                ...
                @if(auth()->user()->role === 'admin' || auth()->user()->role === 'support' || auth()->user()->role === 'utilisateur')
                    <li>
                        <a href="{{ route('tickets.index') }}"
                            ...
                            <span class="text-xl ms-3">Liste des Tickets</span>
                        </a>
                    </li>
                @endif
            @endauth
                ...
                @if(auth()->user()->role === 'utilisateur')
                    <li>
                        <a href="{{ route('tickets.create') }}"
                            ...
                            <span class="text-xl ms-3">Création d'un Ticket</span>
                        </a>
                    </li>
                @endif
            @endauth
                ...
                @if(auth()->user()->role === 'support')
                    <li>
                        <a href="{{ route('tickets.response') }}"
                            ...
                            <span class="text-xl ms-3">Réponse aux Tickets</span>
                        </a>
                    </li>
                @endif
            @endauth
                ...
                @if(auth()->user()->role === 'utilisateur')
                    <li>
                        <a href="{{ route('tickets.my-tickets') }}"
                            ...
                            <span class="text-xl ms-3">Mes Tickets</span>
                        </a>
                    </li>
                @endif
            @endauth
                ...
                @if(auth()->user()->role === 'admin')
                    <li>
                        <a href="{{ route('users.index') }}"
                            ...
                            <span class="text-xl ms-3">Gestion des Utilisateurs</span>
                        </a>
                    </li>
                @endif
            @endauth
